module Jasmine
  module Dependencies
    ...
    class << self
      ...
      def rails3_or_later?
        safe_gem_check("rails", ">= 3.0") && running_rails3_or_later?
      end
      ...
      def rails_3_asset_pipeline?
        rails3_or_later? && Rails.respond_to?(:application) && Rails.application.respond_to?(:assets) && Rails.application.assets
      end
